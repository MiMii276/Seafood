...
class RegistrationController extends AbstractController
{
    ...
    public function register(
        ...
        if ($request->isMethod('POST')) {
            ...
            if (empty($errors)) {
                try {
                    ...
                    // Log the registration - FIXED: Passed $user object first
                    $activityLogger->log($user, 'REGISTER', 'User registered: ' . $email . ' - Verification email sent');
        ...
        // Dashboard fix style directory route
    ...
    public function verifyEmail(
        ...
        if ($user) {
            // FIXED: Passed $user object first
            $activityLogger->log($user, 'EMAIL_VERIFIED', 'User verified email: ' . $user->getEmail());
    ...
    public function resendVerification(
        ...
        if ($request->isMethod('POST')) {
            ...
            // FIXED: Passed $user object first
            $activityLogger->log($user, 'RESEND_VERIFICATION', 'Resent verification email to: ' . $email);
